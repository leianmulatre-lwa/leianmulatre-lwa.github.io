(()=>{
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      body.night-mode #studioApp .profile-card,body.night-mode #studioApp .music-card,body.night-mode #studioApp .aura-card,body.night-mode #studioApp .visitor-log-card,body.night-mode #studioApp .mobile-dock.hero-action-bar,body.night-mode #studioApp .masonry .card:not(.manifesto-card){background:color-mix(in srgb,var(--widget-bg,rgba(250,247,241,.84)) 16%,rgba(31,28,27,.95) 84%)!important;border-color:rgba(255,255,255,.11)!important;color:#f5eee7!important;box-shadow:0 18px 45px rgba(0,0,0,.25)!important}
