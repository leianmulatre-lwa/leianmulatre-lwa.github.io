(()=>{
  ...
  function ensureStyles(){
    ...
    @media(prefers-reduced-motion:reduce){#studioApp .music-card.stereo-music-widget.is-playing .stereo-eq i{animation:none!important}}
      ...
      @media(min-width:901px){#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w{grid-template-columns:minmax(0,1fr) 224px!important;column-gap:18px!important;align-items:start!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail{grid-column:2!important;grid-row:1!important;grid-template-columns:minmax(0,1fr)!important;align-content:center!important;gap:0!important;width:100%!important;align-self:center!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.music-card,#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.aura-card,#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.guest-check-card{width:100%!important;max-width:none!important;height:150px!important;min-height:150px!important;max-height:150px!important;margin:0!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.aura-card{padding:12px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .guest-check-sheet{min-height:110px!important;padding:14px 12px 8px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w>.hero-action-bar{grid-column:1/-1!important;grid-row:2!important}}
      @media(max-width:900px) and (min-width:561px){#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w{grid-template-columns:minmax(0,1fr) 210px!important;grid-template-rows:auto auto!important;column-gap:14px!important;align-items:start!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w>.profile-card:not(.profile-is-editing){grid-column:1!important;grid-row:1!important;min-height:286px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail{grid-column:2!important;grid-row:1!important;grid-template-columns:minmax(0,1fr)!important;align-content:center!important;gap:0!important;width:100%!important;align-self:center!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.music-card,#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.aura-card,#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.guest-check-card{width:100%!important;max-width:none!important;height:140px!important;min-height:140px!important;max-height:140px!important;margin:0!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.aura-card{padding:12px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .guest-check-sheet{min-height:100px!important;padding:12px 12px 8px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w>.hero-action-bar{grid-column:1/-1!important;grid-row:2!important}}
