(()=>{
  ...
  const STUDIO_ICONS={
    ...
    hanger:'<span class="studio-symbol-mark studio-hanger-symbol" aria-hidden="true"><img class="studio-symbol-image" src="/assets/closet-symbol.png?v=20260925-closet-restore-2" alt="" width="1254" height="1254" loading="eager" decoding="async"></span>',
  ...
  function ensureStyles(){
    ...
    @media(prefers-reduced-motion:reduce){#studioApp .music-card.stereo-music-widget.is-playing .stereo-eq i{animation:none!important}}
      ...
      @media(min-width:901px){#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w{grid-template-columns:minmax(0,1fr) 278px!important;column-gap:18px!important;align-items:start!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail{grid-column:2!important;grid-row:1!important;grid-template-columns:minmax(0,1fr)!important;align-content:start!important;gap:0!important;width:278px!important;align-self:center!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w>.hero-action-bar{grid-column:1/-1!important;grid-row:2!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .profile-card:not(.profile-is-editing){height:auto!important;min-height:224px!important;max-height:none!important;row-gap:0!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .profile-card:not(.profile-is-editing) .profile-avatar{width:106px!important;height:106px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .profile-card:not(.profile-is-editing) .profile-copy{padding:24px 24px 16px 0!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .profile-card:not(.profile-is-editing) .real-rank{position:static!important;left:auto!important;right:auto!important;bottom:auto!important;max-width:none!important;margin:12px 0 0!important;padding:9px 0 0!important;row-gap:3px!important;border-top:1px solid rgba(62,50,45,.10)!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .profile-card:not(.profile-is-editing) .real-rank-explanation{margin-top:1px!important}}
      @media(max-width:900px) and (min-width:561px){#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w{grid-template-columns:minmax(0,1fr) 210px!important;grid-template-rows:auto auto!important;column-gap:14px!important;align-items:start!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail{grid-column:2!important;grid-row:1!important;grid-template-columns:minmax(0,1fr)!important;align-content:start!important;gap:0!important;width:100%!important;align-self:center!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.music-card,#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.aura-card{grid-row:auto!important;width:100%!important;height:112px!important;min-height:112px!important;max-height:112px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w .hero-widget-rail>.guest-check-card{grid-row:auto!important;width:100%!important;min-height:216px!important}#studioApp:not(.profile-editor-wallpaper) .hero.biglwa-hero-1w>.hero-action-bar{grid-column:1/-1!important;grid-row:2!important}}
  ...
  function ensureHeroRail(){
    ...
    const applyHeroLayout=()=>{
      ...
      hero.classList.toggle('biglwa-hero-1w',visible===1);
    };
    applyHeroLayout();
