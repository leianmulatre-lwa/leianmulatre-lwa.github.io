(()=>{
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      #studioApp #games .arcade-folder-depth{position:relative;isolation:isolate;overflow:hidden;margin:-4px 8px 16px;padding:38px 5px 5px;border:5px solid #160e0c;border-radius:18px 18px 10px 10px;background:repeating-linear-gradient(to bottom,rgba(255,255,255,.035) 0 1px,rgba(26,8,6,.06) 2px 4px),linear-gradient(145deg,#b38335 0%,#815122 72%);clip-path:none;box-shadow:inset 0 0 0 3px rgba(255,255,255,.08),0 7px 0 #140d0b,0 12px 20px rgba(0,0,0,.28)}
      #studioApp #games .arcade-folder-depth::before{content:"";position:absolute;left:0;top:0;z-index:1;width:58%;height:54px;background:radial-gradient(circle at 28% 0,rgba(255,249,190,.72),transparent 68%),#f2c450;clip-path:polygon(0 0,73% 0,86% 73%,100% 73%,100% 100%,0 100%);box-shadow:inset 0 0 0 3px rgba(255,255,255,.18),0 4px 9px rgba(45,23,12,.2)}
      #studioApp #games .games-arcade-brand{position:relative;z-index:2;isolation:isolate;overflow:visible;min-height:96px;margin:0;padding:0;border:0;border-radius:11px 11px 6px 6px;background:radial-gradient(circle at 29% 0,rgba(255,249,190,.74),transparent 62%),#f2c450;clip-path:none;box-shadow:inset 0 0 0 3px rgba(255,255,255,.24),0 -3px 8px rgba(49,25,13,.22)}
      ...
      #studioApp #games .games-arcade-brand::after{content:"";position:absolute;inset:0;z-index:4;pointer-events:none;background:repeating-radial-gradient(circle at 25% 30%,rgba(255,255,255,.34) 0 1px,transparent 1px 4px),repeating-radial-gradient(circle at 75% 65%,rgba(47,9,18,.28) 0 1px,transparent 1px 5px);opacity:.16;animation:biglwa-arcade-static .42s steps(2,end) infinite}
