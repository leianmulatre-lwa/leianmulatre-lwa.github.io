(()=>{
  ...
  const STUDIO_ICONS={
    ...
    feed:'<span class="studio-symbol-mark studio-feed-symbol" aria-hidden="true"><svg class="studio-symbol-source" viewBox="0 0 32 32" fill="none"><path d="M5.5 11.5h9.6a5.2 5.2 0 0 1 5.2 5.2v.6a5.2 5.2 0 0 1-5.2 5.2H5.5a3.2 3.2 0 0 1-3.2-3.2v-4.6a3.2 3.2 0 0 1 3.2-3.2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="24.4" cy="16.9" r="3.1" stroke="currentColor" stroke-width="2"/><path d="M20.3 16.9h1" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><circle cx="8.5" cy="16.6" r="1.1" fill="currentColor"/></svg></span>',
    diary:'<span class="studio-symbol-mark studio-diary-symbol" aria-hidden="true"><svg class="studio-symbol-source" viewBox="0 0 32 32" fill="none"><path d="M4.5 7.5h8.1A3.4 3.4 0 0 1 16 10.9v13.6a3.4 3.4 0 0 0-3.4-2.8H4.5V7.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M27.5 7.5h-8.1a3.4 3.4 0 0 0-3.4 3.4v13.6a3.4 3.4 0 0 1 3.4-2.8h8.1V7.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 10.9v13.6M7.5 11.5h3.7M21 11.5h3.5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg></span>',
    ...
    quickNotes:'<span class="studio-symbol-mark studio-quick-notes-symbol" aria-hidden="true"><svg class="studio-symbol-source" viewBox="0 0 32 32" fill="none"><path d="M7 4.5h13l5 5v18H7V4.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M20 4.5v6h5M11 16h10M11 21h7" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg></span>',
