(() => {
  ...
  style.textContent = `
    ...
    .module-workspace .module-arcade-folder-depth{position:relative;isolation:isolate;overflow:hidden;margin:0 18px;padding:52px 7px 7px;border:5px solid #150d0b;border-radius:22px 22px 11px 11px;background:repeating-linear-gradient(to bottom,rgba(255,255,255,.035) 0 1px,rgba(26,8,6,.06) 2px 4px),linear-gradient(145deg,#ad7b30 0%,#73461e 74%);clip-path:none;box-shadow:inset 0 0 0 3px rgba(255,255,255,.08),0 8px 0 #120b0a,0 14px 22px rgba(0,0,0,.25)}
    .module-workspace .module-arcade-folder-depth::before{content:"";position:absolute;left:0;top:0;z-index:1;width:58%;height:72px;background:radial-gradient(circle at 28% 0,rgba(255,249,190,.76),transparent 68%),#f0c34f;clip-path:polygon(0 0,73% 0,86% 73%,100% 73%,100% 100%,0 100%);box-shadow:inset 0 0 0 3px rgba(255,255,255,.18),0 5px 11px rgba(45,23,12,.22)}
    .module-workspace .module-game-stage-head{position:relative;z-index:2;isolation:isolate;overflow:visible;display:block;min-height:126px;margin:0;padding:0;border:0;border-radius:13px 13px 7px 7px;background:radial-gradient(circle at 29% 0,rgba(255,249,190,.76),transparent 64%),#f0c34f;color:#1c1410;clip-path:none;box-shadow:inset 0 0 0 3px rgba(255,255,255,.2),0 -4px 10px rgba(46,22,11,.22)}
    ...
    .module-workspace .module-game-stage-head::after{content:"";position:absolute;inset:0;z-index:4;pointer-events:none;background:repeating-radial-gradient(circle at 25% 30%,rgba(255,255,255,.34) 0 1px,transparent 1px 4px),repeating-radial-gradient(circle at 75% 65%,rgba(47,9,18,.28) 0 1px,transparent 1px 5px);opacity:.16;animation:biglwaModuleArcadeStatic .42s steps(2,end) infinite}
