(() => {
  ...
  style.textContent = `
    ...
    .module-workspace .module-game-stage-head{position:relative;isolation:isolate;overflow:hidden;display:grid;grid-template-columns:1fr;align-items:center;justify-items:center;margin:0 18px;padding:12px 28px 14px;border:5px solid #150d0b;border-radius:18px 18px 8px 8px;background:radial-gradient(circle at 50% 0,rgba(255,249,190,.72),transparent 62%),#f0c34f;color:#1c1410;clip-path:polygon(5% 9%,19% 9%,24% 0,76% 0,81% 9%,95% 9%,100% 19%,100% 100%,0 100%,0 19%);box-shadow:inset 0 0 0 3px rgba(255,255,255,.2),0 8px 0 #120b0a,0 14px 22px rgba(0,0,0,.25)}
    ...
    .module-workspace .module-arcade-marquee{position:relative;z-index:2;display:grid;justify-items:center;width:min(500px,100%);margin:auto}.module-workspace .module-arcade-marquee img{display:block;max-width:100%;height:auto;object-fit:contain;object-position:center}.module-workspace .module-arcade-marquee img:first-child{width:min(270px,58%);margin:-7px auto -20px}.module-workspace .module-arcade-marquee img:last-child{width:min(360px,82%);margin:-4px auto 0;mix-blend-mode:normal}
    .module-workspace .module-game-stage-head>span{position:absolute;right:30px;top:18px;z-index:5;color:#564426!important}
    .module-workspace .module-game-stage-head p{color:#564426!important}
    .module-workspace .module-game-folder{position:relative;isolation:isolate;margin:48px 0 0;padding:14px;border-radius:0 21px 21px 21px;background:linear-gradient(145deg,#241a18,#100d0d 74%);box-shadow:0 9px 0 #0c0807,0 17px 27px rgba(0,0,0,.3),inset 0 0 0 4px rgba(129,78,58,.3)}
    .module-workspace .module-game-folder::before{content:"";position:absolute;left:0;top:-34px;z-index:0;width:42%;height:42px;border-radius:18px 18px 0 0;background:linear-gradient(135deg,#33231f,#151010 78%);clip-path:polygon(0 100%,0 24%,4% 0,62% 0,73% 72%,100% 72%,100% 100%);box-shadow:inset 0 4px 0 rgba(255,218,145,.08)}
    .module-workspace .module-game-viewport{position:relative;z-index:1;isolation:isolate;height:clamp(440px,50vw,560px);margin:0;padding:13px;border:0;border-radius:5px 16px 16px 16px;background:#020506;clip-path:none;outline:0;box-shadow:inset 0 30px 35px rgba(0,0,0,.84),inset 25px 0 32px rgba(0,0,0,.72),inset -25px 0 32px rgba(0,0,0,.72),inset 0 -24px 30px rgba(0,0,0,.68);-webkit-mask-image:none;mask-image:none}
    ...
    @media(max-width:560px){.module-workspace .module-game-folder{margin-top:40px;padding:9px}.module-workspace .module-game-folder::before{top:-28px;height:35px;width:54%}.module-workspace .module-game-viewport{height:420px;padding:9px}.module-workspace .module-game-stage-head>span{display:none}.module-workspace .module-arcade-marquee img:first-child{width:min(220px,62%);height:auto!important}.module-workspace .module-arcade-marquee img:last-child{width:min(290px,86%)}}
