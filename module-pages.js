(() => {
  ...
  style.textContent = `
    ...
    @media (prefers-reduced-motion:reduce){.module-game-track,.module-game-stage-head::after{animation:none!important}}
    @media(max-width:850px){.module-game-viewport{height:290px}.module-game-form{grid-template-columns:1fr}}
    @media(max-width:560px){.module-game-stage{padding:15px 14px 108px!important;border-width:8px!important}.module-game-viewport{grid-template-columns:repeat(2,minmax(0,1fr));height:310px}.module-game-track:nth-child(3){display:none}.module-game-stage-head{grid-template-columns:1fr;justify-items:center;gap:3px;padding-inline:8px}.module-game-stage-head>span{font-size:8px}.module-arcade-marquee img:first-child{height:67px!important}.module-arcade-controls{left:17px!important;right:61px!important;gap:13px!important}.module-arcade-joystick{transform:scale(.86);transform-origin:50% 100%}}
    ...
    .module-workspace{border-radius:0;min-height:calc(100vh - 66px);padding-bottom:150px;-webkit-backdrop-filter:blur(var(--widget-blur,18px));backdrop-filter:blur(var(--widget-blur,18px));background:linear-gradient(180deg,color-mix(in srgb,var(--widget-bg,rgba(246,240,233,.94)) 96%,transparent) 0%,color-mix(in srgb,var(--widget-bg,rgba(239,231,223,.96)) 92%,transparent) calc(100% - 118px),color-mix(in srgb,var(--widget-bg,rgba(239,231,223,.96)) 72%,transparent) calc(100% - 76px),color-mix(in srgb,var(--widget-bg,rgba(239,231,223,.96)) 35%,transparent) calc(100% - 30px),transparent 100%);color:var(--widget-ink,#272321)}
    ...
    body.night-mode .module-workspace{background:linear-gradient(180deg,color-mix(in srgb,var(--widget-bg,rgba(31,29,28,.97)) 96%,#191716) 0%,color-mix(in srgb,var(--widget-bg,rgba(25,23,22,.96)) 88%,transparent) calc(100% - 118px),color-mix(in srgb,var(--widget-bg,rgba(25,23,22,.96)) 58%,transparent) calc(100% - 70px),transparent 100%)}
    ...
    .module-workspace .module-card:has(.diary-lined){border-left:14px solid rgb(var(--aura-rgb,216,95,109));background-color:rgb(var(--aura-rgb,216,95,109));background-image:url("/assets/composition-marble.svg?v=20260916-composition-1");background-size:360px 240px;background-blend-mode:screen;box-shadow:inset 6px 0 0 rgba(255,255,255,.25),0 14px 30px rgba(35,25,20,.18)}
    ...
    .module-workspace .module-game-stage{position:relative;padding:24px 24px 118px;border:11px solid #1b0e0c;border-radius:38px 38px 20px 20px;background:linear-gradient(90deg,#25120f,#65382a 13%,#784b38 50%,#603226 87%,#21100e);box-shadow:inset 0 0 0 3px rgba(255,218,145,.14),inset 0 -88px 0 rgba(17,9,8,.58),inset 17px 0 20px rgba(0,0,0,.22),inset -17px 0 20px rgba(0,0,0,.22),0 24px 38px rgba(34,23,18,.27)}
    .module-workspace .module-game-stage-head{position:relative;isolation:isolate;overflow:hidden;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;padding:10px 16px 13px;border:5px solid #150d0b;border-radius:18px 18px 8px 8px;background:radial-gradient(circle at 50% 0,rgba(255,249,190,.72),transparent 62%),#f0c34f;color:#1c1410;box-shadow:inset 0 0 0 3px rgba(255,255,255,.2),0 8px 0 #120b0a,0 14px 22px rgba(0,0,0,.25)}
    .module-workspace .module-game-stage-head::before{content:"";position:absolute;inset:0;z-index:3;pointer-events:none;background:repeating-linear-gradient(to bottom,rgba(255,255,255,.08) 0 1px,rgba(20,8,7,.11) 2px 3px);mix-blend-mode:overlay}
    .module-workspace .module-game-stage-head::after{content:"";position:absolute;inset:-35%;z-index:4;pointer-events:none;background:repeating-radial-gradient(circle at 25% 30%,rgba(255,255,255,.34) 0 1px,transparent 1px 4px),repeating-radial-gradient(circle at 75% 65%,rgba(47,9,18,.28) 0 1px,transparent 1px 5px);opacity:.16;animation:biglwaModuleArcadeStatic .42s steps(2,end) infinite}
    .module-workspace .module-arcade-marquee{position:relative;z-index:2;display:grid;justify-items:center;width:min(430px,100%);margin:auto}.module-workspace .module-arcade-marquee img:first-child{display:block;height:86px;max-width:100%;margin:-17px auto -21px;object-fit:contain}.module-workspace .module-arcade-marquee img:last-child{display:block;width:min(310px,92%);max-width:100%;margin:-7px auto 0;mix-blend-mode:multiply}
    .module-workspace .module-game-stage-head p,.module-workspace .module-game-stage-head span{color:#564426!important}
    .module-workspace .module-game-viewport{margin-top:17px;padding:13px;border:12px solid #141111;border-radius:15px;background:#050708;box-shadow:inset 0 0 28px rgba(74,222,232,.15);-webkit-mask-image:none;mask-image:none}
    .module-workspace .module-game-stage::before{content:"25¢";position:absolute;right:27px;bottom:54px;display:grid;place-items:center;width:30px;height:38px;border:2px solid #090706;border-radius:4px;background:#191414;color:#e5c16e;font:800 8px/1 Inter,ui-sans-serif,system-ui,sans-serif;box-shadow:inset 0 0 0 2px #4a3b35}
    .module-workspace .module-game-stage::after{content:"PLAYER 1";position:absolute;right:25px;bottom:22px;color:#e8d7c7;font:800 7px/1 Inter,ui-sans-serif,system-ui,sans-serif;letter-spacing:.14em}
    .module-workspace .module-arcade-controls{position:absolute;left:28px;right:78px;bottom:17px;display:flex;align-items:end;justify-content:center;gap:28px;height:75px;border-top:5px solid #170d0b;border-radius:48% 48% 12px 12px/20px 20px 10px 10px;background:linear-gradient(180deg,#754432,#382019);box-shadow:inset 0 6px 9px rgba(255,220,164,.09),0 -5px 0 #180d0b}
    .module-workspace .module-arcade-joystick{--stick:#dd5c70;position:relative;width:44px;height:68px;filter:drop-shadow(0 5px 2px rgba(0,0,0,.35))}.module-workspace .module-arcade-joystick::before{content:"";position:absolute;left:50%;bottom:13px;width:8px;height:39px;border-radius:5px;background:linear-gradient(90deg,#171313,#5b5b5b,#151111);transform:translateX(-50%) rotate(var(--tilt,0deg));transform-origin:50% 100%}.module-workspace .module-arcade-joystick::after{content:"";position:absolute;left:50%;top:0;width:31px;height:31px;border-radius:50%;background:radial-gradient(circle at 36% 27%,rgba(255,255,255,.58),transparent 24%),var(--stick);box-shadow:inset -5px -6px 8px rgba(0,0,0,.22),0 0 0 2px rgba(17,10,9,.58);transform:translateX(-50%)}.module-workspace .module-arcade-joystick>i{position:absolute;left:50%;bottom:5px;width:40px;height:14px;border:3px solid #140c0a;border-radius:50%;background:#281714;transform:translateX(-50%);box-shadow:inset 0 2px 0 rgba(255,255,255,.1)}
    .module-workspace .module-arcade-joystick.is-yellow{--stick:#efc548;--tilt:-7deg}.module-workspace .module-arcade-joystick.is-red{--stick:rgb(var(--aura-rgb,216,95,109));--tilt:4deg}.module-workspace .module-arcade-joystick.is-green{--stick:#5ca975;--tilt:-3deg}
  ...
  function miniCalendarMarkup(){
    ...
    const cells=Array.from({length:42},(_,i)=>{const d=calendarGridDate(year,month,i),same=d.getMonth()===month,today=dayKey(d)===dayKey(now);return `<span class="${today?'today':''}" style="${same?'':'opacity:.35'}">${d.getDate()}</span>`}).join('');
    return `<div class="calendar-mini"><div class="calendar-mini-head"><span>${now.toLocaleString(undefined,{month:'long'})}</span><span>${year}</span></div><div class="calendar-mini-grid">${cells}</div></div>`;
  }
  ...
  function renderWriting(key){
    ...
    const title=key==='diary'?`<div class="module-diary-cover-label"><strong>Diary</strong><span>Property of: ${esc(profileUsername())}</span></div>`:'<h2>Scratchpad</h2>';
    body.innerHTML=heading(key)+`<div class="module-grid"><section class="module-card wide">${title}<textarea class="module-textarea ${key==='diary'?'diary-lined':''}" id="moduleWritingArea" placeholder="Write here…">${esc(localStorage.getItem(storage)||'')}</textarea><div class="module-status" id="moduleWritingStatus">Private to this browser · autosaves</div></section></div>`;
  ...
  function renderCamera(){
    ...
    $('#cameraFile',body).onchange=e=>{const f=e.target.files?.[0];if(!f)return;const url=URL.createObjectURL(f);stage.innerHTML=`<img src="${url}" alt="Selected photo">`;cap.disabled=true;status.textContent='Local photo preview — nothing uploaded.'};
  }
  ...
  function openModule(rawKey, context='', push=true){
    stopCamera();let key=(rawKey||'').toLowerCase();if(key==='room')key='rooms';if(key==='project')key='projects';if(key==='didyouknow')key='learn';if(!known.has(key))key='create';activeModuleKey=key;main.classList.add('module-view');workspace.hidden=false;routeName.textContent=labels[key]||key;
