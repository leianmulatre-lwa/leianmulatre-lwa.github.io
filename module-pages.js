(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:560px){.module-game-stage{padding:15px 14px 108px!important;border-width:8px!important}.module-game-viewport{grid-template-columns:repeat(2,minmax(0,1fr));height:310px}.module-game-track:nth-child(3){display:none}.module-game-stage-head{grid-template-columns:1fr;justify-items:center;gap:3px;margin-inline:4px!important;padding-inline:18px}.module-game-stage-head>span{font-size:8px}.module-arcade-marquee img:first-child{height:67px!important}.module-arcade-controls{left:17px!important;right:61px!important;gap:13px!important}.module-arcade-joystick{transform:scale(.86);transform-origin:50% 100%}}
    ...
    .module-workspace[data-module-key="diary"]{background-color:#0b0b0d;background-image:linear-gradient(180deg,rgba(0,0,0,.04),rgba(0,0,0,.16)),url("/assets/composition-texture.webp?v=20260917-composition-2");background-size:auto,680px 453px;background-repeat:repeat;color:#fff}
    .module-workspace[data-module-key="diary"] .module-heading{width:min(1160px,calc(100% - 28px));margin:0 auto 22px;padding:18px 20px;border:1px solid rgba(255,255,255,.24);border-radius:12px;background:rgba(10,10,12,.84);box-shadow:0 8px 24px rgba(0,0,0,.24)}
    .module-workspace[data-module-key="diary"] .module-heading h1,.module-workspace[data-module-key="diary"] .module-heading p{color:#fff;text-shadow:0 2px 8px #000}
    ...
    .module-workspace .module-game-stage{position:relative;padding:24px 24px 118px;border:11px solid #1b0e0c;border-radius:34px 34px 18px 18px;background:linear-gradient(90deg,#25120f,#65382a 13%,#784b38 50%,#603226 87%,#21100e);clip-path:polygon(4% 0,96% 0,100% 4%,100% 93%,97% 100%,3% 100%,0 93%,0 4%);box-shadow:inset 0 0 0 3px rgba(255,218,145,.14),inset 0 -88px 0 rgba(17,9,8,.58),inset 17px 0 20px rgba(0,0,0,.22),inset -17px 0 20px rgba(0,0,0,.22),0 24px 38px rgba(34,23,18,.27)}
    .module-workspace .module-game-stage-head{position:relative;isolation:isolate;overflow:hidden;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;margin:0 18px;padding:10px 28px 13px;border:5px solid #150d0b;border-radius:18px 18px 8px 8px;background:radial-gradient(circle at 50% 0,rgba(255,249,190,.72),transparent 62%),#f0c34f;color:#1c1410;clip-path:polygon(5% 9%,19% 9%,24% 0,76% 0,81% 9%,95% 9%,100% 19%,100% 100%,0 100%,0 19%);box-shadow:inset 0 0 0 3px rgba(255,255,255,.2),0 8px 0 #120b0a,0 14px 22px rgba(0,0,0,.25)}
    .module-workspace .module-game-stage-head::before{content:"";position:absolute;inset:0;z-index:3;pointer-events:none;background:radial-gradient(circle,#fff5ad 0 3px,#e8bc4c 3.3px 4.8px,transparent 5.1px) left 9px center/16px 22px repeat-y,radial-gradient(circle,#fff5ad 0 3px,#e8bc4c 3.3px 4.8px,transparent 5.1px) right 9px center/16px 22px repeat-y,repeating-linear-gradient(to bottom,rgba(255,255,255,.08) 0 1px,rgba(20,8,7,.11) 2px 3px);mix-blend-mode:normal}
    ...
    .module-workspace .module-game-viewport{margin-top:17px;padding:13px;border:12px solid #141111;border-radius:15px;background:#050708;clip-path:polygon(2% 0,98% 0,100% 100%,0 100%);box-shadow:inset 0 0 28px rgba(74,222,232,.15);-webkit-mask-image:none;mask-image:none}
  ...
  function renderWriting(key){
    ...
    body.innerHTML=heading(key)+`<div class="module-grid"><section class="module-card wide">${title}<textarea class="module-textarea ${key==='diary'?'diary-lined':'qwiky-note-input'}" id="moduleWritingArea" placeholder="Write here…">${esc(localStorage.getItem(storage)||'')}</textarea><div class="module-status" id="moduleWritingStatus">Private to this browser · autosaves</div></section></div>`;
