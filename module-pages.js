(() => {
  ...
  style.textContent = `
    ...
    .module-workspace .module-game-stage-head{position:relative;isolation:isolate;overflow:hidden;display:grid;grid-template-columns:1fr;align-items:center;justify-items:center;margin:0 18px;padding:28px 28px 14px;border:5px solid #150d0b;border-radius:20px 20px 9px 9px;background:radial-gradient(circle at 35% 0,rgba(255,249,190,.74),transparent 63%),#f0c34f;color:#1c1410;clip-path:polygon(4% 0,36% 0,43% 18%,96% 18%,100% 28%,100% 100%,0 100%,0 9%);box-shadow:inset 0 0 0 3px rgba(255,255,255,.2),0 8px 0 #120b0a,0 14px 22px rgba(0,0,0,.25)}
    ...
    .module-workspace .module-game-stage-head>span{position:absolute;right:30px;top:35px;z-index:5;color:#564426!important}
    ...
    @media(max-width:560px){.module-workspace .module-game-viewport{height:420px;padding:9px;border-width:10px}.module-workspace .module-game-stage-head{padding-top:24px}.module-workspace .module-game-stage-head>span{display:none}.module-workspace .module-arcade-marquee img:first-child{width:min(220px,62%);height:auto!important}.module-workspace .module-arcade-marquee img:last-child{width:min(290px,86%)}}
