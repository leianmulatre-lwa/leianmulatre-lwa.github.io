(() => {
  ...
  style.textContent = `
    ...
    .module-workspace .module-arcade-folder-depth{position:relative;isolation:isolate;margin:0 18px;padding:10px 0 0 10px}
    .module-workspace .module-arcade-folder-depth::before{content:"";position:absolute;inset:0 10px 10px 0;z-index:0;background:linear-gradient(145deg,#ad7b30,#73461e 74%);clip-path:polygon(3% 0,28% 0,42% 30%,96% 30%,100% 39%,100% 100%,0 100%,0 8%);box-shadow:0 12px 22px rgba(20,10,8,.34)}
    .module-workspace .module-game-stage-head{position:relative;z-index:1;isolation:isolate;overflow:hidden;display:block;min-height:172px;margin:0;padding:0;border:5px solid #150d0b;border-radius:20px 20px 9px 9px;background:radial-gradient(circle at 29% 0,rgba(255,249,190,.76),transparent 64%),#f0c34f;color:#1c1410;clip-path:polygon(3% 0,28% 0,42% 30%,96% 30%,100% 39%,100% 100%,0 100%,0 8%);box-shadow:inset 0 0 0 3px rgba(255,255,255,.2),0 8px 0 #120b0a,0 14px 22px rgba(0,0,0,.25)}
    ...
    @media(max-width:560px){.module-workspace .module-arcade-folder-depth{margin-inline:4px;padding:7px 0 0 7px}.module-workspace .module-arcade-folder-depth::before{inset:0 7px 7px 0}.module-workspace .module-game-viewport{height:420px;padding:9px;border-width:10px}.module-workspace .module-game-stage-head{min-height:132px;margin:0!important}.module-workspace .module-game-stage-head>span{display:none}.module-workspace .module-arcade-marquee img:first-child{width:min(31%,142px);height:auto!important}.module-workspace .module-arcade-marquee img:last-child{width:min(45%,205px)}}
