(() => {
  ...
  style.textContent = `
    ...
    .module-workspace{position:relative;isolation:isolate;border-radius:0;min-height:calc(100vh - 66px);padding-bottom:150px;-webkit-backdrop-filter:blur(var(--widget-blur,18px));backdrop-filter:blur(var(--widget-blur,18px));background:linear-gradient(180deg,color-mix(in srgb,var(--widget-bg,rgba(246,240,233,.94)) 96%,transparent) 0%,color-mix(in srgb,var(--widget-bg,rgba(239,231,223,.96)) 92%,transparent) calc(100% - 118px),color-mix(in srgb,var(--widget-bg,rgba(239,231,223,.96)) 72%,transparent) calc(100% - 76px),color-mix(in srgb,var(--widget-bg,rgba(239,231,223,.96)) 35%,transparent) calc(100% - 30px),transparent 100%);color:var(--widget-ink,#272321)}
    .module-workspace:before{content:"";position:absolute;right:0;bottom:0;left:0;z-index:0;height:min(380px,46vh);pointer-events:none;background:linear-gradient(to top,rgba(var(--aura-rgb,216,95,109),.38),rgba(var(--aura-rgb,216,95,109),.14) 40%,transparent 100%)}
