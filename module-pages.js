(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:560px){.module-workspace .module-game-viewport{height:420px;padding:9px;border-width:10px}.module-workspace .module-game-stage-head>span{display:none}.module-workspace .module-arcade-marquee img:first-child{width:min(220px,62%);height:auto!important}.module-workspace .module-arcade-marquee img:last-child{width:min(290px,86%)}}
