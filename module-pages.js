(() => {
  ...
  style.textContent = `
    ...
    .module-workspace .module-card:has(.diary-lined)>h2,.module-workspace .module-card:has(.diary-lined)>p{display:inline-block;padding:7px 10px;background:#fff;color:#171717;border:2px solid #171717}
    ...
    .module-workspace .module-game-stage{position:relative;padding:24px 24px 82px;border:9px solid #1b110f;border-radius:30px 30px 18px 18px;background:linear-gradient(90deg,#321b17,#714937 48%,#2b1815);box-shadow:inset 0 0 0 2px rgba(255,218,145,.16),inset 0 -42px 0 rgba(17,10,9,.55),0 20px 34px rgba(34,23,18,.24)}
    .module-workspace .module-game-stage-head{padding:12px 15px;border:4px solid #150d0b;border-radius:14px 14px 7px 7px;background:radial-gradient(circle at 50% 0,rgba(var(--aura-rgb,216,95,109),.42),transparent 68%),#f0c34f;color:#1c1410;box-shadow:0 6px 0 #120b0a}
    ...
    .module-workspace .module-game-stage::before{content:"";position:absolute;left:50%;bottom:25px;width:29px;height:29px;border-radius:50%;background:rgb(var(--aura-rgb,216,95,109));box-shadow:-52px 3px 0 #edc545,52px 3px 0 #59a56f,0 -20px 0 -6px #111;transform:translateX(-50%)}
    .module-workspace .module-game-stage::after{content:"INSERT IMAGINATION";position:absolute;right:25px;bottom:18px;color:#e8d7c7;font:800 7px/1 Inter,ui-sans-serif,system-ui,sans-serif;letter-spacing:.14em}
  `;
