(() => {
  ...
  style.textContent = `
    ...
    .module-workspace .module-arcade-controls{position:absolute;left:28px;right:28px;bottom:17px;display:flex;align-items:end;justify-content:center;gap:28px;height:75px;border-top:5px solid #170d0b;border-radius:17px 17px 10px 10px;background:linear-gradient(180deg,#85513d 0%,#6a3d2d 58%,#2b1714 59%,#382019 100%);clip-path:polygon(7% 0,93% 0,100% 100%,0 100%);box-shadow:inset 0 6px 9px rgba(255,220,164,.11),inset 0 -9px 12px rgba(12,6,5,.3);filter:drop-shadow(0 -5px 0 #180d0b) drop-shadow(0 7px 4px rgba(0,0,0,.28));transform:perspective(620px) rotateX(3deg);transform-origin:50% 100%}
